...
public class StatementDesignatorParent extends Designator_Statement {

    private Designator_Call_Method Designator_Call_Method;

    public StatementDesignatorParent (Designator_Call_Method Designator_Call_Method) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementDesignatorParent(\n");
